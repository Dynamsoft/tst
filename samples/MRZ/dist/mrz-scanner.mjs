...
* @author Dynamsoft
* @version 4.0.0-beta-202602180001
...
*/
import * as e from "@dynamsoft/dynamsoft-capture-vision-bundle";
import { CameraEnhancer as t, CaptureVisionRouter as n, CapturedResultReceiver as r, CodeParserModule as i, CoreModule as a, EnumCapturedResultItemType as o, EnumCodeType as s, EnumCrossVerificationStatus as c, EnumValidationStatus as l, Feedback as u, IdentityProcessor as d, ImageProcessor as f, IntermediateResultReceiver as p, LicenseManager as m, MultiFrameResultCrossFilter as h, _toBlob as g, _toCanvas as _ } from "@dynamsoft/dynamsoft-capture-vision-bundle";
//#region src/views/utils/types.ts
var v = /* @__PURE__ */ function(e) {
	return e.MRZ = "mrz", e.Opposite = "opposite", e;
}({}), y = /* @__PURE__ */ function(e) {
	return e.TD3 = "td3", e.TD1 = "td1", e.TD2 = "td2", e.Visa = "visa", e.TD1AndTD2 = "td1AndTd2", e.All = "all", e;
...
var T = (e) => !e || Object.keys(e).length === 0;
function ee(e, t) {
	return t ? {
		...e,
		...t
...
var O = "\n  .dynamsoft-mrz-loading-screen {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background-color: #323234;\n    z-index: 998;\n    opacity: 1;\n    transition: opacity 0.2s ease-out;\n  }\n\n  .dynamsoft-mrz-loading-screen.fade-out {\n    opacity: 0;\n  }\n\n  .dynamsoft-mrz-loading {\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    color: white;\n    z-index: 999;\n    transform: translate(-50%, -50%);\n  }\n\n  .dynamsoft-mrz-loading-content {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    gap: 16px;\n  }\n\n  .dynamsoft-mrz-loading svg {\n    animation: spin 1s linear infinite;\n  }\n\n  .dynamsoft-mrz-loading-message {\n    color: white;\n    font-family: \"Verdana\";\n    font-size: 14px;\n    text-align: center;\n    max-width: 200px;\n    line-height: 1.4;\n    opacity: 0.9;\n  }\n\n  @keyframes spin {\n    from {\n      transform: rotate(0deg);\n    }\n    to {\n      transform: rotate(360deg);\n    }\n  }\n", k = /* @__PURE__ */ function(e) {
	...
	[k.InvalidFields]: "Invalid Fields",
	[k.DocumentType]: "Document Type",
	[k.DocumentNumber]: "Document Number",
	[k.MRZText]: "MRZ Text",
	[k.FirstName]: "Given Name(s)",
	[k.LastName]: "Surname",
	[k.Age]: "Age",
	[k.Sex]: "Sex",
	[k.IssuingState]: "Issuing State",
	[k.IssuingStateRaw]: "Issuing State (Raw Value)",
	[k.Nationality]: "Nationality",
	[k.NationalityRaw]: "Nationality State (Raw Value)",
	[k.DateOfBirth]: "Date Of Birth (YYYY-MM-DD)",
	[k.DateOfExpiry]: "Date Of Expiry (YYYY-MM-DD)",
	[k.OptionalData1]: "Optional Data 1",
	[k.OptionalData2]: "Optional Data 2"
};
function j(e) {
	let t = /* @__PURE__ */ new Date(), n = t.getMonth() + 1 > e.month || t.getMonth() + 1 === e.month && t.getDate() >= e.day;
	return t.getFullYear() - e.year - (n ? 0 : 1);
}
...
var P = new Set(Object.values(s));
function F(e) {
	if (!P.has(e)) throw Error(`Unknown document type: ${e}`);
	return e;
}
function I(e) {
	return e === "D<<" ? "D" : e;
...
function L(e, t) {
	let n = [], r = (e) => t.getFieldValidationStatus(e) === l.VS_FAILED, i = F(t.codeType), a = i === s.CT_MRTD_TD3_PASSPORT ? "passportNumber" : "documentNumber", o = M(t.getFieldValue("birthYear"), t.getFieldValue("birthMonth"), t.getFieldValue("birthDay")), c = M(t.getFieldValue("expiryYear"), t.getFieldValue("expiryMonth"), t.getFieldValue("expiryDay"), !0);
	[
		"birthYear",
		"birthMonth",
		"birthDay"
	].forEach((e) => {
		r(e) && n.push(k.DateOfBirth);
	}), [
		"expiryYear",
		"expiryMonth",
		"expiryDay"
	].forEach((e) => {
		r(e) && n.push(k.DateOfExpiry);
	});
	let u = {
		[k.LastName]: t.getFieldValue("primaryIdentifier"),
		[k.FirstName]: t.getFieldValue("secondaryIdentifier"),
		[k.Nationality]: t.getFieldValue("nationality"),
		[k.NationalityRaw]: I(t.getFieldRawValue("nationality")),
		[k.DocumentNumber]: t.getFieldValue(a) || t.getFieldValue("longDocumentNumber"),
		[k.IssuingState]: t.getFieldValue("issuingState"),
		[k.IssuingStateRaw]: I(t.getFieldRawValue("issuingState")),
		[k.Sex]: E(t.getFieldValue("sex"))
	};
	...
	let d = j(o);
	return d < 1 && n.push(k.Age), {
		[k.InvalidFields]: n,
		[k.FirstName]: u[k.FirstName],
		[k.LastName]: u[k.LastName],
		[k.Age]: d,
		[k.DateOfBirth]: o,
		[k.Sex]: u[k.Sex],
		[k.Nationality]: u[k.Nationality],
		[k.NationalityRaw]: u[k.NationalityRaw],
		[k.DocumentNumber]: u[k.DocumentNumber],
		[k.DateOfExpiry]: c,
		[k.IssuingState]: u[k.IssuingState],
		[k.IssuingStateRaw]: u[k.IssuingStateRaw],
		[k.DocumentType]: i,
		[k.MRZText]: e
	};
}
var R = class {
	...
	getDocumentImage(e) {
		return e === v.MRZ ? this._primaryDocumentImage : this._secondaryDocumentImage;
	}
	getOriginalImage(e) {
		return e === v.MRZ ? this._primaryOriginalImage : this._secondaryOriginalImage;
	}
	getPortraitImage() {
		return this._portraitImage;
	}
}, z = 14, B = .05, V = 3, H = .75, U = .05, W = .5;
function G(e) {
	e.toCanvas = () => _(e), e.toBlob = async () => await g("image/png", e);
}
function te(e) {
...
function ne(e, t, n, r) {
	if (r && t) return r(e, t);
	if (t?.area && e.area) return t.area / e.area >= V;
	if (!e.area) return !1;
	let i = n.width * n.height, a = e.area / i;
	return a >= U && a <= W;
}
function K(e) {
	let t = e.processedDocumentResult?.detectedQuadResultItems?.[0];
	return !t || t.crossVerificationStatus === c.CVS_FAILED ? null : t.location;
}
function q(e, t, n) {
	let r = e.points, i = (r[0].x + r[1].x + r[2].x + r[3].x) / 4, a = (r[0].y + r[1].y + r[2].y + r[3].y) / 4, o = n ? n.width - 1 : Infinity, s = n ? n.height - 1 : Infinity;
	return { points: r.map((e) => {
		let n = e.x - i, r = e.y - a, c = Math.sqrt(n * n + r * r) || 1;
		return {
			x: Math.max(0, Math.min(o, e.x + n / c * t)),
			y: Math.max(0, Math.min(s, e.y + r / c * t))
		};
	}) };
}
async function J(e, t = {}) {
	let { returnDocumentImage: n = !1, returnPortraitImage: r = !1, validatePortraitLocation: i } = t, a = e.items.filter((e) => e.type === o.CRIT_ORIGINAL_IMAGE);
	if (a.length === 0) throw Error("No image data found in captured result");
	let s = a[0].imageData;
	G(s);
	let l = e?.parsedResult?.parsedResultItems, u = {};
	if (l?.length) {
		let e = l[0]?.referenceItem?.text || "", t = l[0];
		u = L(e, t);
	}
	let p = null;
	if (r) try {
		p = await d.findPortraitZone();
	} catch {}
	let m = null, h = null;
	if (n) try {
		let t = e.processedDocumentResult, n = t?.detectedQuadResultItems?.[0];
		if (n) {
			let e = n.location, r = s.width * s.height, i = e?.area ?? 0, a = i / r;
			if (n.crossVerificationStatus !== c.CVS_FAILED && e && i > 0 && a >= B) if (h = e, a > H) m = s;
			else {
				let e = t?.deskewedImageResultItems?.[0];
				if (e?.imageData) m = e.imageData, G(m);
				else {
					let e = q(h, z, s);
					m = await f.cropAndDeskewImage(s, e), G(m);
				}
			}
		}
		m ||= s;
	...
	if (r && p) try {
		...
		if (ne(p, h, s, i)) {
			let e = q(p, z, s);
			g = await f.cropAndDeskewImage(s, e), G(g);
		}
	} catch {}
	return {
		imageData: s,
...
function de(e) {
	if (!e) return "";
	let t = [];
	for (let [n, r] of Object.entries(ue)) {
		let i = e[n];
...
function X(e, t, n) {
	...
	return r.className = `mrz-icon-btn ${e}`, r.setAttribute("role", "button"), r.setAttribute("aria-label", t), r.setAttribute("tabindex", "0"), r.innerHTML = n, Y(r), r;
}
function me(e) {
	let { showUpload: t, showFormatSelector: n, showSoundToggle: r, toolbarButtonsConfig: i, formatSelectorConfig: a, messagesConfig: o, themeConfig: s } = e, c = (e) => ({
		...se[e],
		...i?.[e]
	}), l = {
		close: c("close"),
		upload: c("upload"),
		cameraSwitch: c("cameraSwitch"),
		flash: c("flash"),
		flashOff: c("flashOff"),
		sound: c("sound"),
		soundOff: c("soundOff")
	}, u = ee(ce, a), d = ee(le, o), f = document.createElement("div");
	f.className = "mrz-scanner-overlay";
	let p = document.createElement("div");
	p.className = "mrz-top-bar";
	let m = document.createElement("div");
	m.className = "mrz-top-safe-spacer";
	let h = document.createElement("div");
	h.className = "mrz-top-bar-inner";
	let g = X("mrz-close-btn", l.close.label, l.close.icon);
	l.close.className && g.classList.add(l.close.className), l.close.isHidden && g.classList.add("mrz-hidden");
	let _ = document.createElement("div");
	_.className = "mrz-top-controls";
	let v = X("mrz-upload-btn", l.upload.label, l.upload.icon);
	l.upload.className && v.classList.add(l.upload.className), (!t || l.upload.isHidden) && v.classList.add("mrz-hidden");
	let y = document.createElement("span");
	y.className = "mrz-top-divider", (!t || l.upload.isHidden) && y.classList.add("mrz-hidden");
	let b = X("mrz-camera-btn", l.cameraSwitch.label, l.cameraSwitch.icon);
	l.cameraSwitch.className && b.classList.add(l.cameraSwitch.className), l.cameraSwitch.isHidden && b.classList.add("mrz-hidden");
	let x = document.createElement("span");
	x.className = "mrz-top-divider";
	let S = X("mrz-flash-btn", l.flash.label, "");
	l.flash.className && S.classList.add(l.flash.className), l.flash.isHidden && S.classList.add("mrz-hidden");
	let C = document.createElement("span");
	C.innerHTML = l.flashOff.icon;
	let w = document.createElement("span");
	w.innerHTML = l.flash.icon, w.style.display = "none", S.appendChild(C), S.appendChild(w);
	let T = X("mrz-sound-btn", l.sound.label, "");
	l.sound.className && T.classList.add(l.sound.className), (!r || l.sound.isHidden) && T.classList.add("mrz-hidden");
	let E = document.createElement("span");
	E.innerHTML = l.soundOff.icon;
	let D = document.createElement("span");
	D.innerHTML = l.sound.icon, D.style.display = "none", T.appendChild(E), T.appendChild(D), _.append(v, y, b, x, S, T), h.append(g, _), p.append(m, h);
	let O = document.createElement("div");
	O.className = "mrz-guide-wrapper";
	let k = document.createElement("div");
	k.className = "mrz-badge";
	let A = document.createElement("span");
	A.className = "mrz-badge-line";
	let j = document.createElement("span");
	j.className = "mrz-badge-line", j.style.display = "none", k.append(A, j);
	let M = document.createElement("div");
	M.className = "mrz-guide-frame", M.innerHTML = re;
	let N = document.createElement("div");
	N.className = "mrz-flip-animation";
	let P = document.createElement("div");
	P.className = "mrz-flip-card";
	let F = document.createElement("div");
	F.className = "mrz-flip-card-front", F.innerHTML = ae;
	let I = document.createElement("div");
	I.className = "mrz-flip-card-back", I.innerHTML = oe, P.append(F, I), N.appendChild(P), M.appendChild(N);
	let L = document.createElement("div");
	L.className = "mrz-skip-portrait-label", L.setAttribute("role", "button"), L.setAttribute("tabindex", "0"), L.textContent = d.skipPortraitLabel, Y(L), O.append(k, M, L);
	let R = null, z = null, B = null, V = null, H = null, U = null;
	if (n) {
		R = document.createElement("div"), R.className = "mrz-format-selector";
		let e = document.createElement("div");
		e.className = "mrz-format-buttons-row";
		let t = (e, t = !1) => {
			let n = document.createElement("div");
			return n.className = `mrz-format-btn${t ? " mrz-format-active" : ""}`, n.setAttribute("role", "button"), n.setAttribute("tabindex", "0"), n.textContent = e, Y(n), n;
		};
		V = t(u.visaLabel), H = t(u.allLabel, !0), z = t(u.passportLabel), B = t(u.idLabel), U = document.createElement("div"), U.className = "mrz-format-indicator", e.append(V, H, z, B), R.append(U, e);
	}
	f.append(p, O), R && f.appendChild(R);
	let W = de(s);
	if (W) {
		let e = document.createElement("style");
		e.textContent = W, f.appendChild(e);
	}
	return {
		overlay: f,
		closeBtn: g,
...
var he = {
	...
	s.CT_MRTD_TD1_ID,
	s.CT_MRTD_TD2_ID,
	s.CT_MRTD_TD3_PASSPORT,
	s.CT_MRTD_TD2_VISA,
	s.CT_MRTD_TD3_VISA,
	s.CT_MRTD_TD2_FRENCH_ID
], ge = {
	...Object.fromEntries(Z.map((e) => [e, he])),
	[s.CT_MRTD_TD1_ID]: {
		width: 85.6,
		height: 53.98
	},
	...
	static {
		this.PORTRAIT_STABLE_FRAMES_REQUIRED = 10;
	}
	showScannerLoadingOverlay(e) {
		let t = C(this.config.container);
	...
	async initialize() {
		if (!this.initialized) {
			this.initializeScanModeManager(), this.currentScanMode = this.getScanMode(), w("dynamsoft-mrz-loading-screen-style", O), w("dynamsoft-mrz-scanner-view-style", pe);
			try {
				let { cameraView: e, cameraEnhancer: t, cvRouter: n } = this.resources;
				if (!e || !t || !n) throw Error("Camera resources not initialized");
				try {
				...
				if (n.setInput(t), this.config.enableMultiFrameCrossFilter === !0) {
					let e = new h();
					e.enableResultCrossVerification(o.CRIT_TEXT_LINE, !0), this.resources.returnDocumentImage && e.enableResultCrossVerification(o.CRIT_DETECTED_QUAD, !0), await n.addResultFilter(e);
				}
				let i = new r();
				if (i.onCapturedResultReceived = (e) => this.handleMRZResult(e), n.addResultReceiver(i), this.resources.returnPortraitImage) {
					let e = new p();
					e.onLocalizedTextLinesReceived = (e) => {
						this.latestLocalizedTextLines = e;
					}, n.getIntermediateResultManager().addResultReceiver(e);
				}
				this.initialized = !0;
			} catch (e) {
				let t = e?.message || e;
				console.error(t), alert(t), this.closeCamera();
				let n = new R({ status: S.RS_FAILED });
	...
	initializeUI() {
		let t = C(this.config.container);
		if (!t) throw Error("Container element not found");
		let n = t.children[t.children.length - 1];
		if (n?.shadowRoot && !n.shadowRoot.querySelector("#mrz-dce-hide-style")) {
			let e = document.createElement("style");
			e.id = "mrz-dce-hide-style", e.textContent = fe, n.shadowRoot.appendChild(e);
		}
		if (this.ui = me({
			showUpload: this.config.showUploadImage !== !1,
			showFormatSelector: this.config.showFormatSelector === !0 && this.shouldShowFormatSelector(),
			showSoundToggle: this.config.showSoundToggle !== !1,
	...
	async probeFlashSupport() {
		try {
			let { cameraEnhancer: e } = this.resources;
			if (!e) return;
			await e.turnOffTorch(), this.ui?.flashBtn.classList.remove("mrz-hidden");
		} catch {
			this.ui?.flashBtn.classList.add("mrz-hidden");
		}
	}
	async switchCamera() {
		try {
			let { cameraEnhancer: e } = this.resources;
			if (!e) return;
			let t = await e.getAllCameras();
			if (t.length <= 1) {
				this.ui?.cameraSwitchBtn.classList.add("mrz-hidden");
				return;
			}
			let n = e.getSelectedCamera()?.deviceId === this.defaultBackCameraId, r;
	...
	setGuideFrame(e) {
		...
		this.ui.guideFrame.innerHTML = e === "mrz" ? re : ie, this.ui.guideFrame.appendChild(t);
	}
	...
	static {
		this.FORMAT_DOC_TYPES = {
			passport: [s.CT_MRTD_TD3_PASSPORT],
			id: [
				s.CT_MRTD_TD1_ID,
				s.CT_MRTD_TD2_ID,
				s.CT_MRTD_TD2_FRENCH_ID
			],
			visa: [s.CT_MRTD_TD2_VISA, s.CT_MRTD_TD3_VISA],
			all: Z
		};
	}
	static {
		this.FORMAT_SCAN_MODES = {
			passport: y.TD3,
			id: y.TD1AndTD2,
			visa: y.Visa,
			all: y.All
	...
	static buildScanModeManager(e) {
		let t = new Set(e);
		return Object.fromEntries(Z.map((e) => [e, t.has(e)]));
	}
	async setFormatMode(t) {
		try {
			this.scanModeManager = e.buildScanModeManager(e.FORMAT_DOC_TYPES[t]), this.currentScanMode = e.FORMAT_SCAN_MODES[t], this.stopCapturing(), this.updateScanRegion(), await this.startCapturing(), this.syncFormatButtons();
		} catch (e) {
			console.error("MRZ Scanner switch scan mode error:", e?.message || e), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
		}
	}
	syncFormatButtons() {
		if (!this.ui) return;
		let { formatPassportBtn: t, formatIdBtn: n, formatVisaBtn: r, formatAllBtn: i } = this.ui;
		if (!t || !n || !r || !i) return;
		let a = this.scanModeManager, o = a[s.CT_MRTD_TD3_PASSPORT], c = a[s.CT_MRTD_TD1_ID] || a[s.CT_MRTD_TD2_ID] || a[s.CT_MRTD_TD2_FRENCH_ID], l = a[s.CT_MRTD_TD2_VISA] || a[s.CT_MRTD_TD3_VISA], u = "all";
		o && !c && !l ? u = "passport" : c && !o && !l ? u = "id" : l && !o && !c && (u = "visa"), this.currentFormatMode = u;
		let d = {
			visa: r,
			all: i,
			passport: t,
		...
		for (let [e, t] of Object.entries(d)) t.className = `mrz-format-btn${e === u ? " mrz-format-active" : ""}`;
		let f = e.FORMAT_ORDER.indexOf(u), p = d[u].parentElement;
		p.style.transform = `translateX(${(1.5 - f) * 25}%)`;
	}
	updateScanRegion() {
		...
		switch (this.currentScanMode) {
			...
			case y.TD2:
				...
				break;
			case y.Visa:
				e = s.CT_MRTD_TD2_VISA;
				break;
			default:
				e = s.CT_MRTD_TD3_PASSPORT;
				break;
		}
	...
	calculateScanRegion(e) {
		...
		let r = ge[e].width / ge[e].height, i = n.getVisibleRegionOfVideo({ inPixels: !0 });
		if (!i) return;
	...
	async openCamera() {
		try {
			...
			let n = C(this.config.container);
			if (!n) throw Error("Container element not found");
			n.style.display = "block";
			let r = t.getUIElement();
			if (e.isOpen()) e.isPaused() && await e.resume();
			else {
				r.parentElement || n.append(r), await e.open();
				let t = e.getSelectedCamera();
				t && (this.defaultBackCameraId = t.deviceId);
			}
			let i = r.shadowRoot;
			if (i) {
			...
			let a = await e.getAllCameras(), o = a.find((e) => /front|user|selfie/i.test(e.label));
			a.length > 1 && (o || a.some((e) => e.deviceId !== this.defaultBackCameraId)) ? this.ui?.cameraSwitchBtn.classList.remove("mrz-hidden") : this.ui?.cameraSwitchBtn.classList.add("mrz-hidden"), await this.probeFlashSupport(), window.addEventListener("resize", this.handleResize);
		} catch (e) {
			let t = e?.message || e;
			console.error(t), alert(t), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
		}
	}
	async closeCamera(e = !0) {
		try {
			...
			let { cameraEnhancer: t, cameraView: n } = this.resources, r = C(this.config.container);
	...
	handleCloseBtn() {
		...
		} else this.currentScanResolver(new R({ status: S.RS_CANCELLED })), this.resetScanningState();
	}
	...
	async uploadFile() {
		...
		t.type = "file", t.accept = this.config.uploadAcceptedTypes ?? "image/*", t.style.display = "none", document.body.appendChild(t);
		try {
			...
			let n = await new Promise((e, n) => {
				t.onchange = (t) => {
					...
					this.hideScannerLoadingOverlay(!1), this.showScannerLoadingOverlay("Initializing camera..."), await this.openCamera(), this.setGuideFrameVisible(!0), this.updateScanRegion(), await this.startCapturing(), this.hideScannerLoadingOverlay();
				}), t.click();
			});
			if (!n) return;
			let r;
			if (this.config.uploadFileConverter && !n.type.startsWith("image/")) try {
				r = await this.config.uploadFileConverter(n);
			} catch (e) {
			...
			let i = this.config.utilizedTemplateNames[this.currentScanMode], a = await J(await e.capture(r, i), {
				returnDocumentImage: this.resources.returnDocumentImage,
				returnPortraitImage: this.resources.returnPortraitImage,
				validatePortraitLocation: this.validatePortraitLocation.bind(this)
			});
			this.originalImageData = a.imageData;
			let o = new R({
				status: S.RS_SUCCESS,
				data: a.processedData,
				primaryOriginalImage: a.imageData,
				primaryDocumentImage: a.primaryDocumentImage,
				portraitImage: a.portraitImage
			});
			this.resources.onResultUpdated?.(o), this.currentScanResolver?.(o);
		} catch (e) {
			let t = e?.message || e;
			console.error(t), alert(t), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
		} finally {
	...
	initializeScanModeManager() {
		...
		this.scanModeManager = e.buildScanModeManager(Z), !(!t || Array.isArray(t) && t.length === 0) && (Object.keys(this.scanModeManager).forEach((e) => {
	...
	getScanMode() {
		let e = this.scanModeManager, t = e[s.CT_MRTD_TD3_PASSPORT], n = e[s.CT_MRTD_TD1_ID], r = e[s.CT_MRTD_TD2_ID] || e[s.CT_MRTD_TD2_FRENCH_ID], i = e[s.CT_MRTD_TD2_VISA] || e[s.CT_MRTD_TD3_VISA];
		return (t || i) && (n || r) || t && i ? y.All : t ? y.TD3 : i ? y.Visa : n && r ? y.TD1AndTD2 : n ? y.TD1 : r ? y.TD2 : y.All;
	}
	async startCapturing() {
		let { cvRouter: e } = this.resources;
		if (!e) throw Error("Router not initialized");
		let t = this.config.utilizedTemplateNames[this.currentScanMode];
		try {
			this.firstFrame = !0, await e.startCapturing(t);
		} catch (e) {
			let t = e?.message || e;
			console.error("Failed to start capturing:", t), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
		}
	}
	async launch() {
		try {
			...
			let t = e?.message || e;
			console.error("MRZ Scanner launch error:", t), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
		}
	}
	async handleMRZResult(e) {
		...
		if (!(e.items.length <= 1 && !this.isMRZScanned)) {
			if (this.isMRZScanned && !this.isPortraitScanned && this.resources.returnPortraitImage) {
				let t = e.items.filter((e) => e.type === o.CRIT_ORIGINAL_IMAGE);
				if (t.length > 0) {
					let e = t[0].imageData;
					e.toCanvas = () => _(e), e.toBlob = async () => await g("image/png", e), this.originalImageData = e;
				}
				e?.parsedResult?.parsedResultItems?.length ? await this.tryPortraitOnSameSide(e, this.resources.onResultUpdated) : t.length > 0 && await this.handlePortraitSideScan(e, this.resources.onResultUpdated);
				return;
			}
			if (!(e.items.length <= 1)) try {
				let { onResultUpdated: t } = this.resources;
				if (e?.parsedResult?.parsedResultItems?.length) {
					this.isSoundFeedbackOn && !this.isMRZScanned && u.beep();
					let n = await J(e, {
						returnDocumentImage: this.resources.returnDocumentImage,
						returnPortraitImage: !1
					});
					this.originalImageData = n.imageData;
					let r = K(e);
					if (this.resources.returnDocumentImage && !r) return;
					this.isMRZScanned || await this.handleMRZSideScan(n.processedData, n.primaryDocumentImage, r ?? null, t);
				}
			} catch (e) {
				let t = e?.message || e;
				console.error(t), alert(t), this.closeCamera(), this.currentScanResolver?.(new R({ status: S.RS_FAILED }));
	...
	async handleMRZSideScan(e, t, n, r) {
		...
		if (this.resources.returnPortraitImage && this.originalImageData) try {
			let e = await d.findPortraitZone();
			if (e && !e.errorCode && e.points?.length === 4 && (!n || this.validatePortraitLocation(e, n))) {
				let t = q(e, Q, this.originalImageData);
				i = await f.cropAndDeskewImage(this.originalImageData, t), i.toCanvas = () => _(i), i.toBlob = async () => await g("image/png", i), a = !0;
			}
		} catch (e) {
		...
		if (this.isMRZScanned = !0, this.mrzSideData = {
			...
			portraitImage: i
		}, this.resources.returnPortraitImage && !a) this.showGuideSuccessBorder(1e3), this.showBadge(this.messages.scanSuccess, !0, this.messages.scanningPortrait, !1), this.startPortraitSkipTimer();
		else {
			this.areSidesDifferent = !1, this.isPortraitScanned = !0, this.showGuideSuccessBorder(1e3);
	...
	async tryPortraitOnSameSide(t, n) {
		...
		let r = !1;
		try {
			if (!this.hasHighConfidencePortraitZone()) return;
			let e = await d.findPortraitZone();
			if (this.isPortraitScanned) return;
			if (e && !e.errorCode && e.points?.length === 4) {
				let i = K(t);
				if ((!i || this.validatePortraitLocation(e, i)) && this.originalImageData) {
					r = !0;
					let t = q(e, Q, this.originalImageData), i = await f.cropAndDeskewImage(this.originalImageData, t);
					i.toCanvas = () => _(i), i.toBlob = async () => await g("image/png", i), this.flipTimeoutHandle !== null && (window.clearTimeout(this.flipTimeoutHandle), this.flipTimeoutHandle = null), this.flipCountdownHandle !== null && (window.clearInterval(this.flipCountdownHandle), this.flipCountdownHandle = null), this.areSidesDifferent = !1, this.isWaitingForFlip = !1, this.isPortraitScanned = !0, this.mrzSideData.portraitImage = i, this.showGuideSuccessBorder(1e3), this.showBadge(this.messages.scanSuccess, !0, this.messages.portraitScanned, !0), setTimeout(() => {
						this.closeCamera();
						let e = new R({
							status: S.RS_SUCCESS,
							data: this.mrzSideData.processedData,
	...
	async handlePortraitSideScan(t, n) {
		...
		if (!this.hasHighConfidencePortraitZone()) {
			this.consecutiveStablePortraitFrames = 0;
			return;
		}
		let r = null;
		if (this.resources.returnDocumentImage || this.resources.returnPortraitImage) {
			if (r = K(t), r) this.consecutiveStablePortraitFrames++;
			else if (this.consecutiveStablePortraitFrames = 0, this.resources.returnDocumentImage) return;
		...
		try {
			...
			if (e && !e.errorCode && e.points?.length === 4 && this.originalImageData) {
				...
				if (this.resources.returnDocumentImage && r) try {
					let e = q(r, Q, this.originalImageData);
					a = await f.cropAndDeskewImage(this.originalImageData, e), a.toCanvas = () => _(a), a.toBlob = async () => await g("image/png", a);
				} catch (e) {
				...
				try {
					let t = q(e, Q, this.originalImageData);
					o = await f.cropAndDeskewImage(this.originalImageData, t), o.toCanvas = () => _(o), o.toBlob = async () => await g("image/png", o);
				} catch (e) {
					console.warn("Error cropping portrait image:", e);
				}
				this.hideFlipAnimation(), this.isSoundFeedbackOn && u.beep(), this.showGuideSuccessBorder(1e3), this.showBadge(this.messages.scanSuccess, !0, this.messages.bothSidesScanned, !0), setTimeout(() => {
					this.closeCamera();
					let e = new R({
						status: S.RS_SUCCESS,
						data: this.mrzSideData.processedData,
			...
			console.warn("Error finding portrait on second side:", e);
		} finally {
	...
	hasHighConfidencePortraitZone() {
		let e = this.latestLocalizedTextLines?.auxiliaryRegionElements;
		return e ? e.some((e) => e.name === "PortraitZone" && e.confidence > 70) : !0;
	}
	validatePortraitLocation(e, t) {
		return !e.points.every((e) => this.isPointInQuadrilateral(e, t)) || !t.area || !e.area || e.area === 0 ? !1 : t.area / e.area >= _e;
	}
	isPointInQuadrilateral(e, t) {
		let n = t.points, r = !1;
...
}, ve = new URL("./mrz-scanner.ui.html", import.meta.url).href, ye = new URL("./mrz-scanner.template.json", import.meta.url).href, be = {
	dcvBundle: "/dist/@dynamsoft/dynamsoft-capture-vision-bundle/dist/",
	dcvData: "/dist/@dynamsoft/dynamsoft-capture-vision-data/"
}, xe = "100dvh", Se = class {
	...
	hideLoadingOverlay(e = !1) {
		let t = C(this.config.scannerViewConfig?.container);
		t && this.loadingScreen && (this.loadingScreen.hide(), this.loadingScreen = null, t.style.display = "none", e && this.config?.container && (C(this.config.container).style.display = "none"));
	}
	constructor(e) {
	...
	async initialize() {
		...
		try {
			...
			w("dynamsoft-mrz-loading-screen-style", O), this.showLoadingOverlay("Loading..."), await this.initializeDCVResources(), this.resources.onResultUpdated = (e) => {
			...
			let e = {};
			return !this.isFileMode && this.config.scannerViewConfig && (this.scannerView = new $(this.resources, this.config.scannerViewConfig), e.scannerView = this.scannerView, await this.scannerView.initialize()), this.isInitialized = !0, {
				resources: this.resources,
				components: e
			};
		} catch (e) {
	...
	initializeDynamsoftResources() {
		a.engineResourcePaths = T(this.config?.engineResourcePaths) ? be : this.config.engineResourcePaths, a.loadWasm(), i.loadSpec("MRTD"), this.isDynamsoftResourcesLoaded = !0;
	}
	async initializeDCVResources() {
		try {
			if (this.isDynamsoftResourcesLoaded || this.initializeDynamsoftResources(), m._onAuthMessage = (e) => e.replace("(https://www.dynamsoft.com/customer/license/trialLicense?product=unknown&deploymenttype=unknown)", "(https://www.dynamsoft.com/customer/license/trialLicense?product=mrz&deploymenttype=web)"), await m.initLicense(this.config?.license || "", { executeNow: !0 }), !this.isFileMode) {
				let e = this.config.scannerViewConfig?.cameraEnhancerUIPath, n;
				if (e) try {
					n = await fetch(e).then((e) => e.text());
				} catch (t) {
					console.warn(`Failed to fetch UI from ${e}, using default UI:`, t);
				}
				this.resources.cameraEnhancer = await t.createInstance(n), this.resources.cameraView = this.resources.cameraEnhancer;
			}
			this.resources.cvRouter = await n.createInstance(), await n.appendDLModelBuffer([
				"MRZLocalization",
				"MRZCharRecognition",
				"MRZTextLineRecognition"
			]);
			let e = this.config.templateFilePath, r = await this.resources.cvRouter.initSettings(e);
	...
	validateViewConfigs() {
		try {
			if (this.config.container && !C(this.config.container)) {
				let e = "Invalid main container reference";
				return alert(e), console.error(e), !1;
			}
			if (this.config.scannerViewConfig?.container && !C(this.config.scannerViewConfig?.container)) {
	...
	initializeMRZScannerConfig() {
		...
		this.shouldCreateDefaultContainer() ? this.config.container = this.createDefaultMRZScannerContainer() : this.config.container && (this.config.container = C(this.config.container) ?? void 0);
		let e = this.config.container ? this.createViewContainers(C(this.config.container)) : {}, t = {
			license: this.checkForTemporaryLicense(this.config.license),
			utilizedTemplateNames: Object.fromEntries(Object.values(y).map((e) => [e, this.config.utilizedTemplateNames?.[e] || x[e]])),
			templateFilePath: this.config?.templateFilePath || ye
		}, n = {
			...this.config.scannerViewConfig,
			container: e[b.Scanner] || C(this.config.scannerViewConfig?.container) || null,
			cameraEnhancerUIPath: this.config.scannerViewConfig?.uiPath || this.config.scannerViewConfig?.cameraEnhancerUIPath || ve,
	...
	createViewContainers(e) {
		return e.textContent = "", [b.Scanner].reduce((t, n) => {
			let r = document.createElement("div");
	...
	async processUploadedFile(e) {
		try {
			...
			let n = this.config.utilizedTemplateNames.all, r = await t.getSimplifiedSettings(n);
			r.roiMeasuredInPercentage = !0, r.roi.points = [
				{
					x: 0,
					y: 0
				},
			...
			], await t.updateSettings(n, r);
			let i = await J(await t.capture(e, n), {
				returnDocumentImage: this.resources.returnDocumentImage,
				returnPortraitImage: this.resources.returnPortraitImage
			}), a = new R({
				status: S.RS_SUCCESS,
			...
			return console.error("Failed to process uploaded file:", e), new R({ status: S.RS_FAILED });
		} finally {
	...
	async launch(e) {
		...
		try {
			...
			if (this.config.container && (C(this.config.container).style.display = "block"), this.isFileMode) return await this.processUploadedFile(e), this.resources.result;
			...
			return n?.status === S.RS_SUCCESS ? this.resources.result : new R({ status: n?.status ?? S.RS_FAILED });
		} catch (e) {
			let t = e instanceof Error ? e.message : String(e);
			return alert(t), console.error(t), new R({ status: S.RS_FAILED });
		} finally {
...
//#endregion
export { x as DEFAULT_TEMPLATE_NAMES, e as Dynamsoft, Ce as DynamsoftMRZScanner, v as EnumDocumentSide, k as EnumMRZData, y as EnumMRZScanMode, b as EnumMRZScannerViews, S as EnumResultStatus, A as MRZDataLabel, Se as MRZScanner, $ as MRZScannerView, N as displayMRZDate };
