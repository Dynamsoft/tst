...
declare class CaptureVisionRouter {
    ...
    */
    ...
    captureMultiPages(file: Blob | string, templateName?: string, options?: {
        pdfReadingParameter?: PDFReadingParameter;
        pages?: number[];
...
export { EnumLayoutElementSource, EnumLayoutPattern, ImageProcessingModule, LayoutAnalyzer };
export type { LayoutAnalysisParameter, LayoutAnalysisResult, LayoutAxis, LayoutElement };
