...
export declare const DDLS: {
    DriverLicenseScanner: typeof DriverLicenseScanner;
    DriverLicenseNormalizerView: typeof DriverLicenseNormalizerView;
...
export type { DriverLicenseCorrectionViewConfig, DriverLicenseCorrectionViewToolbarButtonsConfig, } from "../views/DriverLicenseCorrectionView";
export type { DriverLicenseResultViewConfig, DriverLicenseResultViewToolbarButtonsConfig, } from "../views/DriverLicenseResultView";
...
export { DriverLicenseScanner, DriverLicenseNormalizerView, DriverLicenseScannerView, DriverLicenseResultView, EnumResultStatus, EnumDriverLicenseScanSide, };
export default DDLS;
